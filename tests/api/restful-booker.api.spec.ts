...
test.describe("Restful book api", () => {
    ...
    test.beforeEach(async ({ request }) => {
        ...
        authToken = await bookingClient.getToken(process.env.API_USERNAME, process.env.API_PASSWORD)
    ...
    test("Create and retrieve a booking", async ({ request }) => {
        ...
        const getResponse = await bookingClient.getBookingById(createdBooking.bookingid);
        ...
        expect(bookingDetails.bookingdates.checkin).toBe(booking.bookingdates.checkin);
        expect(bookingDetails.bookingdates.checkout).toBe(booking.bookingdates.checkout);
    ...
    test("Negative test: Update booking with invalid token", async ({ request }) => {
        const bookingClient = new BookingClient(request);
        const booking = createRandomBooking();
